...
/* package bpl-0.1.0.0 */
#ifndef VERSION_bpl
#define VERSION_bpl "0.1.0.0"
#endif /* VERSION_bpl */
#ifndef MIN_VERSION_bpl
#define MIN_VERSION_bpl(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_bpl */
...
#define CURRENT_COMPONENT_ID "bpl-0.1.0.0-inplace-bpl"
